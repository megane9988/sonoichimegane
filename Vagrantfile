...
WP_HOSTNAME        = "wordpress.sonoichimegane" # e.g example.com
WP_IP              = "192.168.33.99" # host ip address
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :chef_solo do |chef|
    chef.cookbooks_path = [
      "~/Documents/vagrant/moto/vagrant-chef-centos-wordpress/cookbooks", 
      "~/Documents/vagrant/moto/vagrant-chef-centos-wordpress/site-cookbooks"
    ]
